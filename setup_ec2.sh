...
KEY_NAME="market-dashboard-key"
SECURITY_GROUP="market-dashboard-sg"
INSTANCE_NAME="market-dashboard"
REGION="us-east-1"
...
echo ""
echo "배포:"
echo "  git clone https://github.com/USERNAME/market-dashboard.git"
echo "  cd market-dashboard"
