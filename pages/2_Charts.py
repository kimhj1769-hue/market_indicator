...
# Home 카드에서 넘어온 경우 session_state 적용
...
fig.update_layout(
    ...
    height=580, margin=dict(t=44, b=10, l=8, r=8),
    font=dict(color="white", family="Inter"),
    legend=dict(bgcolor="#111126", bordercolor="#1e1e3a", borderwidth=1, font=dict(color="#aaa", size=11)),
...
for col,(lbl,val,vc) in zip([c1,c2,c3,c4,c5], stats):
